...
namespace GhostUnicorns\DocsCustomer\Ui\DataProvider;
...
class CustomerDocsListingDataProvider implements DataProviderInterface
{
    const ENTITY_TYPE_FILTER = 'customer';
    ...
    protected function searchResultToOutput(SearchResultInterface $searchResult): array
    {
        ...
        foreach ($searchResult->getItems() as $item) {
            ...
            if ($entityId === '' || $customerId !== $entityId) {
                continue;
            }
    ...
    public function getSearchCriteria(): SearchCriteria
    {
        $this->addFilter(
            $this->filterBuilder
                ...
                ->setValue(self::ENTITY_TYPE_FILTER)
                ->setConditionType('eq')
                ->create()
        );
